...
def get_columns(filters):
    ...
    if filters.get("show_delegate"):
        columns.extend([
            ...
            {"label": _("الرقم العسكري للمندوب"), "fieldname": "delegated_army_number", "fieldtype": "Data", "width": 180},
...
def get_data(filters):
    conditions = [
        "er.status IN ('قيد الفحص')",
        "er.repair_type = 'مجموعة'"  # شرط ثابت لجلب المعدات فقط
    ]
